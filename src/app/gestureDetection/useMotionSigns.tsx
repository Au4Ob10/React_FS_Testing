...
const useMotionSigns = (landmarks,motionLetter,motionEnabled) => {
  // const indexFingerTip = landmarks.current[0][8]
  // const pinkyFingerVals = landmarks.current[0][20]

  const gestureEstimate = useRef(null);
  
  const letter = motionLetter.current;
  const indexFingerTip = landmarks[0][8]
  const pinkyRef = landmarks[0][20]
